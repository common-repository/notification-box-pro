...
Donate link: 
Tags: Notification Box, Notification, drop shadow box, notice box, alert box, fade in box, scroll triggered box, time triggered box, Zotabox
...
+ Notification Box for Wordpress. Fade in boxes to promote your products on your website.
+ Customize Style, Placement, Images and Display Time. Support scroll / time trigger.
...
<li>Search for 'Notification Box'</li>
...
<ol>
<li>Upload the notification-box folder to the /wp-content/plugins/ directory</li>
